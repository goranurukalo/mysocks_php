...
<?php
            ...
            if($data['thispage']>1){
                $data['paginationHTML'] .= "<a href='index.php?page=".$values['page']."&offset=".$data['prevpageid']."' class='pbtnprev pbtnall'>PREV</a>";
            }
            else{
            ...
            if($data['thispage'] == $data['paginationpages']-1){
                $data['paginationHTML'] .= "<div class='pbtnnext pbtnall'>NEXT</div>";
            }
            else{
                $data['paginationHTML'] .="<a href='index.php?page=".$values['page']."&offset=".$data['nextpageid']."' class='pbtnnext pbtnall'>NEXT</a>";
            }
...
<div class="productcontainer">
    ...
    <div class="productsbody">
        ...
        <?php
            ...
            $query = "SELECT * FROM product ".$fullwhere." ".$fullorder." LIMIT ".$sview." OFFSET ".$data['offset'];
//echo $query;
            $result = mysql_query($query, $connect);
